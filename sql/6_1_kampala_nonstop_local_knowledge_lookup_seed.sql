...
VALUES
    ...
    ('GUIDE_TRAVEL_GUIDE', 'Guide Travel Guide',
     'Long-form Travel Guide topics such as arrival, transport, money, health, connectivity, weather and etiquette.', TRUE),
    ('GUIDE_TRAVEL_INFORMATION', 'Guide Travel Information',
     'Operational Travel Information such as visas, visa-free entry and visa costs.', TRUE),
